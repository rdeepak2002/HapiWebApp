                ...
                querySnapshot.forEach(function (documentSnapshot) {
                    ...
                    if(docCount == querySnapshot.size) {
                        ...
                        for(var i = 0; i < overallAnalysisObjects.length; i++) {
                            ...
                            peopleObjects = peopleObjects.map(function(x){ return x.toLowerCase() })


                            if(overallValues[i].joy >= 0.3 && peopleObjects.indexOf(overallAnalysisObjects[i].toLowerCase())==-1) {
                                joyObjects.push(overallAnalysisObjects[i]);
                            }
                        ...
                        if(joyObjects.length > 0) {
                            $('#toggleShow').show();
                            var objects = "";
                            for(var i = 0; i < joyObjects.length; i++) {
                                if(i != joyObjects.length-1)
                                    objects += joyObjects[i] + ", ";
                                else
                                    objects += joyObjects[i];
                            }    
                            $('#joyPlaceholder').text(objects);                    
                        }
                        else {
                            $('#toggleShow').hide();
                        }
